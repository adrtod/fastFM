...
class FMRegression_weighted(FactorizationMachine, RegressorMixin):
    ...
    def __init__(self, n_iter=100, init_stdev=0.1, rank=8, random_state=123,
        ...
        super(FMRegression_weighted, self).__init__(n_iter=n_iter,
    ...
    def fit(self, X_train, y_train, C, n_more_iter=0):
        ...
        self.w0_, self.w_, self.V_ = ffm.ffm_als_fit_weighted(self, X_train, y_train, C)
...
class FMClassification_weighted(BaseFMClassifier):
    ...
    def __init__(self, n_iter=100, init_stdev=0.1, rank=8, random_state=123,
        ...
        super(FMClassification_weighted, self).__init__(n_iter=n_iter,
                                               init_stdev=init_stdev,
                                               rank=rank,
                                               random_state=random_state)
